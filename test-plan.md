...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **PUB-01** | Browse Communities & Collections | Repository is populated | 1. Go to the homepage<br>2. Click on a Community<br>3. Click on a Collection | The hierarchical structure is displayed correctly. Items within the Collection are listed | Testing | All links are directing to the proper page, however,  search returned no results for <mark>"Department of Computer Science"</mark> while there are collections in published current version. Is this expected?|
| **PUB-02** | Search for Items | Items exist with known metadata | 1. Use the global search bar<br>2. Enter a known keyword from an Item's title | The relevant Item appears in the search results | Testing | Test both simple and advanced search, some seach doesn't return result as expected. Eg. <mark>"Philips Ayeni"</mark>|
| **PUB-03** | View Item Detail Page | An Item is publicly accessible | 1. From a search or browse result, click on an Item title | All Item metadata is displayed correctly. The "Download" button/link for the primary bitstream is visible and functional | Testing | Randomly checked 10 items, all metadata fields display properly. However, some are showing <mark>en_US multiple times under different fields</mark>, eg.https://tempserver-199.lakeheadu.ca/items/13dea760-a9af-4f67-a713-4764f93f509d/full vs https://tempserver-199.lakeheadu.ca/items/3f970794-fbbb-4bbc-907c-101e1c68ebf0/full The same issue occers in published current version too. |
