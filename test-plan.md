...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **PUB-01** | Browse Communities & Collections | Repository is populated | 1. Go to the homepage<br>2. Click on a Community<br>3. Click on a Collection | The hierarchical structure is displayed correctly. Items within the Collection are listed | Testing | All links are directing to the proper page, however, <mark> search returned no results for following Communities: -Orillia -Department of Computer Science -Department of Engineering -Department of History -Physics. Is this expected?</mark>|
| **PUB-02** | Search for Items | Items exist with known metadata | 1. Use the global search bar<br>2. Enter a known keyword from an Item's title | The relevant Item appears in the search results | Pass | Test both simple and advanced search |
